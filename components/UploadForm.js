...
export default function UploadForm(props) {
	...
	return (
		<form
			onSubmit={onSubmit}
			className='p-10 bg-primary-100 sm:m-20 mt-10 rounded-lg shadow-lg font-normal'
		>
			<div className='grid sm:grid-cols-2 gap-4'>
				<div>
					...
					<input
						...
						name='name'
						placeholder='Title'
						className='transition-all p-3 rounded-xl w-full outline-none focus:ring focus:ring-secondary-100'
					/>
				</div>
				<div>
				...
				<div>
					...
					<div className='relative'>
						...
						<input
							...
							ref={priceRef}
							onBlur={() => {
								priceRef.current.value = parseFloat(
									priceRef.current.value
								).toFixed(2);
							}}
							className='transition-all p-3 rounded-xl block pl-7 w-full outline-none focus:ring focus:ring-secondary-100'
						/>
					</div>
				</div>
				<div>
			...
			<div className='flex justify-between'>
				<input
					...
					className='transition-all p-3 bg-tertiary-400 rounded-xl hover:bg-tertiary-300 text-white'
				/>
				<div>
				...
				<button className='transition-all p-3 bg-secondary-300 rounded-xl hover:bg-secondary-200 text-white'>
					Submit
				</button>
			</div>
			{fileExport && (
